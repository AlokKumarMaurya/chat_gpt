      ...
      return Container(
        ...
        child: Row(
          children: [
            ...
            InkWell(
              onTap: (){
                ApiClient().getChatAnswer(question: allListController.chatTextEditingController.text);
                allListController.addToList(value: {1:allListController.chatTextEditingController.text});
                },
              child: Container(
